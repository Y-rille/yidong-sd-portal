...
class VolumeTypeInfo extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
            events: [],
        ...
        return (
            <div>
                <div className={styles.header}>
                    <h1 className={styles.title}>卷类型详情</h1>
                    {nodeInfo ? (
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item><a onClick={this.goList.bind(this)}>卷类型管理</a></Breadcrumb.Item>
                            <Breadcrumb.Item>卷类型详情</Breadcrumb.Item>
                        </Breadcrumb>
                    ) : ''}
                </div>
