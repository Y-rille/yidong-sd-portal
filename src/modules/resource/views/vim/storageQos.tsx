...
class StorageQos extends React.Component<any, any> {
    constructor(props) {
        super(props);
    ...
    getTableData(queryObj) {
        ...
        this.props.actions.queryList('imdsStorageQos', params_obj, () => {
            self.setState({
                tableLoading: false
            });
        })
        ...
        return (
            <div>
                <div className={styles.header}>
                    <h1 className={styles.title}>存储QOS管理</h1>
                    {nodeInfo ? (
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>存储QOS管理</Breadcrumb.Item>
                        </Breadcrumb>
                    ) : ''}
                </div>
